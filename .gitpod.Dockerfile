...
RUN apt-get update \
 ...
 && apt-get clean \
 && rm -rf /var/cache/apt/* /var/lib/apt/lists/* /tmp/*RUN curl -L "https://github.com/docker/compose/releases/download/1.24.1/docker-compose-$(uname -s)-$(uname -m)" -o /usr/local/bin/docker-compose \
